...
void colorcube()
{
    ...
    // specify them here
       quad( 0 ,4,5,1, point3(1.0f, 0.0f, 0.0f));
	quad( 1,5,6,2, point3(0.0f,1.0f,0.0f));
	quad( 2,6,7,3, point3(-1.0f,0.0f, 0.0f));
	quad( 0,4,7,3, point3(0.0f, -1.0f,0.0f));
	quad( 5,4,7,6, point3(0.0f, 0.0f, -1.0f));
